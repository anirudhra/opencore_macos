#!/bin/sh
# enable below
sudo defaults write com.apple.AppleGVA gvaForceAMDKE -boolean no           #forces AMD DRM decoder for streaming services (like Apple TV and iTunes movie streaming)
